...
import Styles from "./mobile-profile-tracker.module.scss";
...
export const MobileProfileTracker: React.FC = () => {
  ...
  return (
    <div className={Styles.wrapper}>
      <div className={Styles["input-select"]}>
        <button
          className={cx(profileInput === "keyboard" && Styles.active)}
          type="button"
        ...
        <button
          className={cx(profileInput === "controller" && Styles.active)}
          type="button"
